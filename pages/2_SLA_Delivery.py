...
late = view[view["on_time"] == False]  # тільки прострочені замовлення
if late.empty or reduction_pp <= 0.0:
    st.info("Немає прострочених замовлень у вибраному періоді.")
    st.stop()       
